...
;EXPLANATION:	ADD		Rd, Rn, Op2    	; Rd is the destination register where the result is stored
...
;ADDS and SUBS could be used here, but we don't need to update condition flags for this program and can reduce overhead.
		B		loop
done
break
